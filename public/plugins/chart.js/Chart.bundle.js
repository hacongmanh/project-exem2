...
/**
 * Computes an "ideal" article-categories based on the absolute bar thickness or, if undefined or null,
...
function computeFitCategoryTraits(index, ruler, options) {
	...
	if (helpers$1.isNullOrUndef(thickness)) {
		...
		// When bar thickness is enforced, article-categories and bar percentages are ignored.
...
/**
 * Computes an "optimal" article-categories that globally arranges bars side by side (no gap when
...
core_defaults._set('scatter', {
	...
	scales: {
		xAxes: [{
			...
			type: 'linear',    // scatter should not use a article-categories axis
			position: 'bottom'
		}],
		yAxes: [{
			id: 'y-axis-1',
...
var scale_category = core_scale.extend({
	...
	_configure: function() {
		...
		if (!me.isHorizontal()) {
			// For backward compatibility, vertical article-categories scale reverse is inverted.
