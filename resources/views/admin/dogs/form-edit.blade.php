                        ...
                        <div class="col-12">
                            <form action="/admin/dogs/{{$obj->id}}" method="post" id="product_form">
                                ...
                                <div class="row form-group">
                                    <div class="col-6">
                                        ...
                                        <input name="name" type="text" class="form-control input-sm"
                                               value="{{$obj->name}}" placeholder="Nhập tên...">
                                        @if($errors->has('name'))
                                    ...
                                    <div class="col-6">
                                        ...
                                        <input name="price" type="text" class="form-control input-sm"
                                               value="{{$obj->price}}" placeholder="Nhập giá tiền...">
                                        @if($errors->has('price'))
                                ...
                                <div class="row form-group">
                                    <div class="col-6">
                                        <label>Màu sắc</label>
                                        <input name="color" type="text" class="form-control input-sm"
                                               value="{{$obj->color}}" placeholder="Nhập màu sắc...">
                                        @if($errors->has('color'))
                                    ...
                                    <div class="row form-group">
                                        <div class="col-3">
                                            <select name="status" class="custom-select">
                                                ...
                                                <option value="1" {{$obj->status == 1 ? 'selected': ''}}>Duyệt Bài
                                                </option>
                                                <option value="0" {{$obj->status == 0 ? 'selected': ''}}>Không Duyệt
                                                </option>
                                            </select>
