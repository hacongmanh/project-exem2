@extends('layout.layout-admin', ['current_page' => 'timeline-list'])
@section('main-content')
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Danh sách timeline</h3>
                </div>
                <div class="card-body">
                    <div class="dataTables_wrapper dt-bootstrap4">
                        <form action="/admin/timeline" method="get" id="search-form">
                            <div class="row">
                                <div class="col-5">
                                    <div class="row">
                                        <div class="col-12">
                                ...
                                <table class="table table-bordered table-hover dataTable dtr-inline">
                                    ...
                                    @foreach($list as $article)
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$article->video}}</td>
                                            <td>
                                                <a href="/admin/timeline/{{$article->id}}/edit" class="btn btn-primary">Edit</a>
