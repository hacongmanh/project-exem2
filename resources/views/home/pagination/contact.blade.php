                        ...
                        <div class="row mb-5">
                            <div class="col-md-3">
                                <div class="dbox w-100 text-center">
                                    ...
                                    <div class="text">
                                        <p><span>Address:</span> 198 đường west 21th, dãy 721 new york ny 10016 </p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-3">
                            ...
                            <div class="col-md-3">
                                <div class="dbox w-100 text-center">
                                    ...
                                    <div class="text">
                                        <p><span>Trang web</span> <a href="#">yoursite.com</a></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="contact-wrap w-100 p-md-5 p-4">
                                    ...
                                    <form method="POST" id="contactForm" name="contactForm" class="contactForm">
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label class="label" for="#">Thông điệp</label>
